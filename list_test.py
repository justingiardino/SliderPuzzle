my_list = [[['.', '.', 'a'], ['x', 'x', 'a'], ['.', '.', 'a'], ['b', '.', '.'], ['b', 'c', 'c']], [['.', '.', 'a'], ['x', 'x', 'a'], ['b', '.', 'a'], ['b', '.', '.'], ['c', 'c', '.']], [['.', '.', 'a'], ['x', 'x', 'a'], ['b', '.', 'a'], ['b', '.', '.'], ['.', 'c', 'c']], [['.', '.', 'a'], ['x', 'x', 'a'], ['b', '.', 'a'], ['b', '.', '.'], ['c', 'c', '.']], [['.', '.', 'a'], ['x', 'x', 'a'], ['b', '.', 'a'], ['b', '.', '.'], ['c', 'c', '.']]]
for temp_l in my_list:
    print(temp_l)
    print("\n\n")
    if [['.', '.', 'a'], ['x', 'x', 'a'], ['b', '.', 'a'], ['b', '.', '.'], ['c', 'c', '.']] == temp_l:
        print("Wowo")
if [['.', '.', 'a'], ['x', 'x', 'a'], ['b', '.', 'a'], ['b', '.', '.'], ['c', 'c', '.']] in my_list:
    print("Wow")


# show_board = [['a', 'a', 'a', '.', '.', 'b'], ['.', '.', 'c', '.', '.', 'b'], ['x', 'x', 'c', '.', '.', 'b'], ['d', '.', 'c', '.', 'e', 'e'], ['d', '.', '.', '.', 'f', '.'], ['g', 'g', 'g', '.', 'f', '.']]
# print(show_board)
# my_list = []
# my_list.append(show_board)
# print(my_list)
# my_list.append([['a', 'a', 'a', '.', '.', 'b'], ['.', '.', 'c', '.', '.', 'b'], ['x', 'x', 'c', 'd', 'd', 'b'], ['d', '.', 'c', '.', 'e', 'e'], ['d', '.', '.', '.', 'f', '.'], ['g', 'g', 'g', '.', 'f', '.']])
# print(my_list)
#
# if [['a', 'a', 'a', '.', '.', 'b'], ['.', '.', 'c', '.', '.', 'b'], ['x', 'x', 'c', '.', '.', 'b'], ['d', '.', 'c', '.', 'e', 'e'], ['d', '.', '.', '.', 'f', '.'], ['g', 'g', 'g', '.', 'f', '.']] in my_list:
#     print("Valid somehow")
# else:
#     print("Nope")
# my_dict = {}
